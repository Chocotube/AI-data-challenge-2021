...
class DecisionTree:
    ...
    def evaluate_with_list(self, x, decision_tree, display_evaluation_flow=True, evaluation_list=[]):
        ...
        #left evaluation
        if x_column_value <= decision_tree.threshold:
            evaluation_list.append(decision_tree.column_name + " : \x1b[0;30;47m\033[1m" + str(x_column_value) + "\x1b[0m\033[0m " + decision_tree.operator + " " + str(decision_tree.threshold))
        ...
        evaluation_list.append(decision_tree.column_name + " : \x1b[0;30;47m\033[1m" + str(x_column_value) + "\x1b[0m\033[0m" + operator + str(decision_tree.threshold))
    ...
    def prediction_analyse(self, X_test, Y_test, confusion_matrix_display=True, proportion_informations=True):
        ...
        if confusion_matrix_display:
            ...
            cm = confusion_matrix(Y_pred, Y_test.squeeze())
            ...
            for i in range(Y_test.shape[1]):
                ...
                print("i == ", i)
                print("laaaa", Y_test, Y_pred)
                print("laaaa", Y_test[i], Y_pred[i])
